(function(){
            ...
            // Elementos de fondo fijo
            const fixedBgElement = document.getElementById("fixedBackground");
            const overlayElement = document.getElementById("overlayBackground");
            ...
            // ---------- PERSONALIZACIÓN VISUAL (Fondo fijo) ----------
            ...
            // Actualizar el fondo FIJO (parallax)
            function setBackgroundImage(imageUrl) {
                if (!imageUrl) {
                    // Fondo por defecto: color sólido oscuro
                    fixedBgElement.style.backgroundImage = "none";
                    fixedBgElement.style.backgroundColor = "#1e1f2c";
                    localStorage.removeItem(BG_KEY);
                    return;
                }
                fixedBgElement.style.backgroundImage = `url("${imageUrl.replace(/"/g, '&quot;')}")`;
                fixedBgElement.style.backgroundSize = "cover";
                fixedBgElement.style.backgroundPosition = "center center";
                fixedBgElement.style.backgroundColor = "transparent";
            ...
            // Oscurecimiento overlay (opcional, se puede ajustar pero se mantiene)
            
            // Eventos de fondo fijo
            bgFileInput.addEventListener("change", (e) => {
                ...
                if (file && file.type.startsWith("image/")) {
                    ...
                    reader.onload = (ev) => { 
                        ...
                        bgUrlInput.value = "local image"; 
                        showToast("Fondo fijo actualizado (imagen local)"); 
                    };
            ...
            setBgUrlBtn.addEventListener("click", () => {
                ...
                if (url) { 
                    ...
                    showToast("Fondo fijo cargado desde URL (efecto parallax)"); 
                } 
